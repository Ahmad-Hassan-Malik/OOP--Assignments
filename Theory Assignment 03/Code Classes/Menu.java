...
//            try {
//                PlayerDesign playerDesign = new PlayerDesign();
//                Stage currentStage1 = (Stage) playerButton.getScene().getWindow();
//                currentStage1.setTitle("Players of PSL...!!!");
//
//                Scene playerScene = new Scene(new StackPane(),1000,800);
//                //currentStage1.setScene(playerDesign.createPlayerScene(currentStage1,playerScene));
//            } catch (Exception e1) {
//                e1.printStackTrace();
//            }
//        });
